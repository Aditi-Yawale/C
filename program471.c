//BINARY SEARCH TREE - countparent
...
void Insert(PPNODE Root, int No)
{
    ...
    else    //Tree contains atleast one node
    {
        ...
        while(1)    //UNCONDITIONAL LOOP - phirat raha jo parynt kuni thambvat nahi
        {
            if(temp->data == No)
            {
...
bool Search(PNODE Root, int No) //Call by value as it does not change the tree
{
    bool flag = false;
