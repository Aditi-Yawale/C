//CYCLE DETECTION - LOOP DETECTION - CHECK IF SLL HAS LOOP
//contains loop will run infinitely
#include<stdio.h>
#include<stdlib.h>
#include<stdbool.h>
...
int main()
{
    ...
    temp2 -> next = temp1;
    //ABOVE LOGIC IS USED TO CREATE A LOOP IN THE LINKED LIST - THE PROBLEM THAT WE HAVE TO DETECT
